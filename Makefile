...
icomp: ompcInsertion.c coordReader.c
	$(ICC) -std=gnu99 -no-multibyte-chars ompcInsertion.c coordReader.c -o icomp.exe -qopenmp -lm

# make ifomp comliles
ifomp: ompfInsertion.c coordReader.c
	$(ICC) -std=gnu99 -no-multibyte-chars ompfInsertion.c coordReader.c -o ifomp.exe -qopenmp -lm
